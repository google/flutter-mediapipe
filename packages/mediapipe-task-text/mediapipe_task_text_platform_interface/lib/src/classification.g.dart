...
class TextClassifierResult {
  ...
  Object encode() {
    return <Object?>[
      classificationResult.encode(),
      timestampMs,
    ];
  }

  static TextClassifierResult decode(Object result) {
    result as List<Object?>;
    return TextClassifierResult(
      classificationResult:
          ClassificationResult.decode(result[0]! as List<Object?>),
      timestampMs: result[1] as double?,
    );
  }
}
...
class _TextClassifierCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is Category) {
      ...
      buffer.putUint8(130);
      writeValue(buffer, value.encode());
    } else if (value is TextClassifierResult) {
      buffer.putUint8(131);
      writeValue(buffer, value.encode());
    } else {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 131:
        return TextClassifierResult.decode(readValue(buffer)!);
      default:
...
class TextClassifier {
  ...
  Future<TextClassifierResult> classify(String arg_value) async {
    ...
    if (replyList == null) {
      ...
      return (replyList[0] as TextClassifierResult?)!;
    }
  }
}
